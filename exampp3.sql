...
--
-- Хост: 127.0.0.1
-- Время создания: Июн 29 2021 г., 13:17
...
CREATE TABLE `time` (
  `id` int(11) NOT NULL,
  `master_id` int(11) NOT NULL,
  `valid_time` varchar(55) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `time` (`id`, `master_id`, `valid_time`) VALUES
(1, 1, '14:00-15:00');
...
--
ALTER TABLE `time`
  ADD CONSTRAINT `time_ibfk_1` FOREIGN KEY (`master_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
